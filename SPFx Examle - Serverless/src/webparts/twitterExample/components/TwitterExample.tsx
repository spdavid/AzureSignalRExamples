...
import styles from './TwitterExample.module.scss';
import { ITwitterExampleProps } from './ITwitterExampleProps';
...
export default class TwitterExample extends React.Component<ITwitterExampleProps, ITweetWatcherState> {
  ...
  constructor(props: ITwitterExampleProps) {
    super(props);
  ...
  public render(): React.ReactElement<ITwitterExampleProps> {
    return (
